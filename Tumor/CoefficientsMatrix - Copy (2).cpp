...
void CoefficientsMatrix() {
	...
	for ( size_t i = 0; i < vessels.size(); ++i ) {
		...
		if ( i == 0 ) {
			...
			int s_node = PositionFinder( nodes, vessels[i].GetStartNode() );
			int in = last_vessel_index + s_node;

			test.put( i, in, 1 );
			coefficients.push_back( T(i,in,1) );
			...
			int e_node = PositionFinder( nodes, vessels[i].GetEndNode() );
			int out = last_vessel_index + e_node;

			test.put( i, out, -1 );
			coefficients.push_back( T(i,out,-1) );
...
// ==================================================================================================================================================================================
	...
	int column = last_vessel_index + pv_segments;
	...
	for ( size_t i = 0; i < vessels.size(); ++i )
		std::cout << vessels[i].GetFlowRate() << std::endl;
